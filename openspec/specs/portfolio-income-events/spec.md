...
O sistema SHALL permitir registro manual de provento para ativo com ao menos uma compra efetivada na carteira. O registro MUST conter retrato do ativo, tipo monetário suportado, moeda compatível com o mercado, data de pagamento e valor recebido positivo; data de elegibilidade, quantidade elegível, valor unitário e observação MAY ser informados. O registro manual MUST ser identificado com origem `MANUAL` e MUST NOT exigir consulta externa nem cálculo de impostos.
...
- **THEN** o sistema cria o registro com origem `MANUAL` e preserva os valores informados
...
- **THEN** o sistema responde com `409`, não cria o registro e não revela dados de outras carteiras

#### Scenario: Dados manuais inválidos
- **WHEN** tipo, moeda, pagamento ou valor recebido não atendem às regras
