...
O sistema SHALL retornar uma coleção de resultados de busca sem persistir ativos pesquisados. Cada resultado SHALL conter ticker, nome, mercado, tipo, moeda e a cotação mais recente disponível do ativo retornada pelo provedor selecionado, sem expor dados brutos ou detalhes internos da integração.
...
- **THEN** o sistema inclui o ativo e sua cotação no resultado da busca
