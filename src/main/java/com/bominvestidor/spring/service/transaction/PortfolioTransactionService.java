...
public class PortfolioTransactionService {
	...
	public PortfolioTransactionService(PortfolioService portfolioService, PortfolioTransactionRepository repository,
			PortfolioTransactionMapper mapper, Clock clock) { this.portfolioService=portfolioService; this.repository=repository; this.mapper=mapper; this.clock=clock; }
	...
	private void reconcile(UUID portfolioId) {
